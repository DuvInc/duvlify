...
<Callout title="CodeBlock is not the same thing" tone="warning">
...
<Callout title="When a diagram is not worth 180 KB" tone="note">
...
<Callout title="Quote your node labels" tone="warning">
...
<Callout title="Resize, don't compress harder" tone="note">
